...
# ================================================
# FETCH GOLD DATA FROM YAHOO FINANCE (NO BLOCKING)
# ================================================
def fetch_gold(interval="1m", limit=500):
    ...
    if r.status_code != 200:
        st.error("Error fetching gold data from Yahoo Finance")
        return None
    ...
    try:
        ...
        st.error("Invalid data format from Yahoo Finance")
        return None
...
st.write("No indicators. Pure price action. Yahoo Finance (No blocking).")
